...
void Analyzer::ConvertTxtToRootFile(string _inFileName){
	...
	tree->Branch("n1", &_product2_Name, "_product2_Name/S");
	tree->Branch("isB1", &_product2_isBoson, "_product2_isBoson/O");
	tree->Branch("m1", &_product2_mass, "_product2_mass_product1_px/F");
	tree->Branch("px1", &_product2_px, "_product2_px/F");
	tree->Branch("py1", &_product2_py, "_product2_py/F");
	tree->Branch("pz1", &_product2_pz, "_product2_pz/F");
	tree->Branch("E1", &_product2_E, "_product2_E/F");
	tree->Branch("pT1", &_product2_pT, "_product2_pT/F");
